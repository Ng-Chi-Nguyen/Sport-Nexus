export const FloatingTextarea = ({
  ...
  return (
    <div className="relative w-full border border-gray-200">
      ...
      <label
        htmlFor={id}
        className="absolute text-sm text-[#323232] duration-300 transform -translate-y-4 scale-75 
        top-2 z-10 origin-[0] bg-white px-2 peer-focus:px-2 peer-focus:text-[#4facf3] 
        peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 
        peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1 font-bold pointer-events-none"
      >
