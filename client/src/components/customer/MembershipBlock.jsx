...
const MembershipBlock = ({ refreshKey }) => {
  ...
  return (
    <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-gradient-to-r from-primary to-rose-50 dark:from-slate-800 dark:to-slate-900 p-5">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-lg font-bold text-slate-900 dark:text-primary">
