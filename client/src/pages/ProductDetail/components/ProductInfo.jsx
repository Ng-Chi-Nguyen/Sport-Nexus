  ...
  return (
    <div className="space-y-4 font-sans text-slate-800 dark:text-slate-100 transition-colors duration-200">
      ...
      <div className="flex gap-2 text-xs flex-wrap items-center">
        <span className="font-extrabold text-sky-600 dark:text-sky-400 bg-sky-50 dark:bg-sky-500/10 border border-sky-200 dark:border-sky-500/20 px-2.5 py-1 rounded-md">
          #SP{product.id}
        </span>

        {product.category && (
          <span className="flex items-center gap-1 font-medium text-slate-600 dark:text-slate-400 bg-slate-100 dark:bg-[#111827]/40 border border-slate-200 dark:border-slate-800/80 px-2.5 py-1 rounded-md">
            <Tag size={12} />
      ...
      {totalReviews > 0 && (
        ...
        >
          <div className="flex items-center gap-1 bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/20 px-2.5 py-1 rounded-md text-amber-500">
      ...
      <div className="p-4 bg-slate-50 dark:bg-[#111827]/40 rounded-2xl border border-slate-200 dark:border-slate-900 shadow-xl dark:shadow-2xl backdrop-blur-md">
        <div className="flex items-baseline gap-3 flex-wrap">
          ...
          {hasDiscount && (
            <>
              ...
              <span className="ml-auto bg-rose-600 dark:bg-rose-500 text-white text-xs font-black px-2.5 py-1 rounded-md shadow-sm">
