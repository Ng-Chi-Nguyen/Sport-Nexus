            ...
            return (
              <button
                ...
                className={`px-4 py-2 text-sm border transition-all ${
                  isSelected
                    ? "border-sky-500 dark:border-sky-500 bg-sky-50/50 dark:bg-sky-500/10 text-sky-600 dark:text-sky-400 font-semibold shadow-sm cursor-pointer"
                    : isAvailable
                      ...
                      : "border-slate-200 dark:border-slate-800/50 text-slate-300 dark:text-slate-600 hover:border-sky-300 dark:hover:border-sky-500/50 cursor-pointer bg-slate-100/50 dark:bg-slate-900/20"
                }`}
              >
                {opt.value}
              </button>
