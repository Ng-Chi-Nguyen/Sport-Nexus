...
const CouponInput = ({
  ...
  return (
    <div
      ref={containerRef}
      className="py-2 text-slate-800 dark:text-slate-100 transition-colors duration-200"
    >
      <div className="flex items-center gap-2">
                ...
                >
                  ...
                  {coupon.min_order_value > 0 && (
                    <p className="text-[11px] text-slate-400 dark:text-slate-500 mt-0.5">
                      {t("coupon_min_order", {
                        value: formatCurrency(coupon.min_order_value),
                      })}
                    </p>
                  )}
                </li>
        ...
        {hasCouponApplied ? (
          ...
          >
            {loading ? t("coupon_checking") : t("coupon_apply")}
          </button>
        )}
      </div>
