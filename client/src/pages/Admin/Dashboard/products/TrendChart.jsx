            ...
            {newProductTrend.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="flex h-[140px] w-full items-end rounded-lg border border-slate-200 bg-slate-50 dark:border-slate-800/80 dark:bg-[#08101E] p-0.5 transition-colors duration-200">
                    <div
